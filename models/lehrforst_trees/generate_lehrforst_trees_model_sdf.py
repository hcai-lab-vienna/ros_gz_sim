...
for i, line in enumerate(lines[1:]):
    ...
    if w < min_diam or i % use_trees or not x_min < x < x_max or not y_min < y < y_max:
        continue
    CSV += f"{x},{y},{z},{w}\n"
...
with open(f"{target_dir}/model.sdf", "w") as f:
    f.write(SDF)

with open(f"{target_dir}/tree_position_filtered.csv", "w") as f:
    f.write(CSV)
